...
my_df = my_df.to_csv('database\my_df.csv',index=False)
서울 = 서울.to_csv('database\서울.csv',index=False)
울산 = 울산.to_csv('database\울산.csv',index=False)
광주 = 광주.to_csv('database\광주.csv',index=False)
대구 = 대구.to_csv('database\대구.csv',index=False)
부산 = 부산.to_csv('database\부산.csv',index=False)
대전 = 대전.to_csv('database\대전.csv',index=False)
인천 = 인천.to_csv('database\인천.csv',index=False)
전남 = 전남.to_csv('database\전남.csv',index=False)
전북 = 전북.to_csv('database\전북.csv',index=False)
경남 = 경남.to_csv('database\경북.csv',index=False)
강원 = 강원.to_csv('database\강원.csv',index=False)
경기 = 경기.to_csv('database\경기.csv',index=False)
제주 = 제주.to_csv('database\제주.csv',index=False)
세종 = 세종.to_csv('database\세종.csv',index=False)
충남 = 충남.to_csv('database\충남.csv',index=False)
